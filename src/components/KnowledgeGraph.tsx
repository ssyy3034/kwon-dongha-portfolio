...
import { DashboardData as GraphData } from "@/lib/graph-loader";
...
const ForceGraph3D = dynamic(() => import("react-force-graph-3d"), {
  ssr: false,
  loading: () => (
    <div className="flex flex-col items-center justify-center h-screen bg-black text-emerald-500 font-mono">
      ...
      <div className="absolute top-8 left-8 z-20 pointer-events-none">
        <div className="flex flex-col gap-1">
          <h1 className="text-4xl font-black text-white tracking-tighter mix-blend-difference">
            MY KNOWLEDGE
            <br />
            <span className="text-emerald-500">UNIVERSE</span>
          </h1>
              ...
              <div key={group} className="flex items-center gap-2 text-xs">
                <div
                  ...
                  style={{
                    ...
                    boxShadow: `0 0 10px ${groupColors[group]}`,
                  }}
                ></div>
      ...
      <div className="absolute bottom-12 left-1/2 -translate-x-1/2 w-full max-w-3xl px-8 z-20 flex flex-col items-center">
        ...
        <div className="w-full h-1 bg-zinc-800 rounded-full overflow-hidden">
          <div
            ...
            style={{
              width: `${(currentDateIndex / (uniqueDates.length - 1)) * 100}%`,
            }}
          />
        </div>
